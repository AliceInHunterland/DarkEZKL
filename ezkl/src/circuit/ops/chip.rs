        ...
        F: Field,
    {
        ...
        for x in 0..input.num_blocks() {
            for y in 0..input.num_inner_cols() {
                ...
                // multisel * product (sel - i) = 0 where sel is the synthetic_sel, and the product is over the set of overflowed columns
                // and multisel is the selector value at the column index
